...
import io.github.ykysnk.serverBackpack.Constants.LOGGER
import io.github.ykysnk.serverBackpack.Constants.Server
...
abstract class AbstractBackpackContainer(private val fileName: String, size: Int = 54) : Container,
    ...
    private fun onInit() {
        ...
        if (Files.exists(dataPath)) {
            runCatching {
                val compoundTag = NbtIo.readCompressed(dataPath, NbtAccounter.unlimitedHeap())
