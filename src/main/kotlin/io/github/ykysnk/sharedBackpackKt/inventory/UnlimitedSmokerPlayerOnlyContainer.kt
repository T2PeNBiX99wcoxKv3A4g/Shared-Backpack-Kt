...
class UnlimitedSmokerPlayerOnlyContainer(player: Player, name: String, override val onNoPlayersOpen: () -> Unit) :
    AbstractUnlimitedFurnaceContainer(
        "player-unlimited-furnace-smoking-${player.stringUUID}-${name}",
        RecipeType.SMOKING
    ) {
