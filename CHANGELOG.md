...
## [0.18.0](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/compare/v0.16.1..v0.18.0) - 2026-09-16

### ⚙️ Miscellaneous Tasks

- *(workflow)* Rename workflow to `Pre Release` for clarity - ([54deae9](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/54deae994409f20321595cdc44e6e3d265501cf7))

### Action

- Update version in `gradle.properties` and update `CHANGELOG.md` - ([c8c15f0](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/c8c15f02ee99173edec7d10e2707a7bb0e836951))


## [0.16.1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/compare/v0.16.0..v0.16.1) - 2026-09-16

### ⚙️ Miscellaneous Tasks

- *(workflow)* Simplify release workflows by reusing `jvm_release` template and updating permissions - ([267d6f7](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/267d6f7d6ee73fd25f8435d888bc6160f5e18624))
- *(workflow)* Update `paths-ignore` to exclude additional files in release workflows - ([3d96143](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/3d961433e2b2ea59a901b1c6fd8cc52a0b97ccad))
- *(workflow)* Replace custom Dependabot auto-merge logic with reusable workflow - ([6893866](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/68938668a19001ba129ebdd6b08ef8de76291f2f))
- *(workflow)* Add step to request Dependabot PR recreation on merge conflicts - ([70ccc39](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/70ccc392429f88fed77ec9bfe2bce5be5514b6f1))

### Action

- Update version in `gradle.properties` - ([def3cf6](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/def3cf69118acef906b1013a842a678eb8173e22))
...
- *(build)* Improve `toConstantName` function for better camelCase to constant conversion - ([4e94be3](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/4e94be321556cb8686402f6ac40e378f73a44d46))
- *(build)* Update `modmenu` version constraint in `fabric.mod.json` for broader compatibility - ([7109193](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/710919302efd827c780cf499ed2443821982141d))
- *(build)* Use dynamic `group` property in fallback translations generation - ([f9d4248](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/f9d4248167de713d87d385fb7ab9763a235febc8))
- *(build)* Replace hardcoded values in `fabric.mod.json` with placeholders for improved flexibility - ([16cc8b9](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/16cc8b9a16d79c41eed54c283aaf41c83eef23c1))
- *(build)* Update Gradle configuration for improved modularity and dependency management - ([64b3105](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/64b31050cac83833395f1f2c225e423f2f084f17))
- *(commands)* Remove obsolete commands and registration logic following modularization of functionality - ([16004c1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/16004c1de1c9cf7b8c5528e1ebe28a1973aacfda))
- *(config)* Validate `unlimitedFurnaceMultiplier` with `ValidatedInt` for improved input safety - ([c431b7f](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/c431b7f8c60ab9c6e765bb81b03b8dc5063420d3))
- *(config)* Change `MainConfig` properties to mutable for enhanced flexibility in configuration handling - ([e5f3670](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/e5f367076f243dadd8a9e530b70b37b484c0871b))
- *(config)* Restructure `MainConfig` into sections for improved organization and readability - ([f3a0fc0](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/f3a0fc09a9a7a057880e8dc5e75615e39268090b))
- *(config)* Replace `Configs.config.general` with `Configs.mainConfig` across commands for consistency and maintainability - ([d1e0b9b](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/d1e0b9bd50c548c4113e512f12e500671b7c3820))
- *(config)* Remove custom config and ModMenu integration in favor of `fzzy_config` - ([00bf3b0](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/00bf3b0e9f71288a68b63b12bd278f6b9858280b))
- *(core)* Replace `Utils` with `Constants` for centralized constants management - ([a183393](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/a183393ba2e0962493da652b020f079b38915451))
- *(core)* Add `Constants` and `NameSpaces` for improved modularity and configuration handling - ([762846a](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/762846a18c4190b24944f18f173b8ac4d7be29c3))
- *(inventory)* Enhance null safety and modernize syntax in container classes - ([509cada](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/509cadaa3d2baca82e390f63cbfe1ac68c8beefa))
- *(lang)* Update language keys to reflect namespace change from `shared-backpack-kt` to `server-backpack` - ([ad58329](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/ad58329885970bd1020c185fe70494322c1fe451))
- *(lang)* Update language keys to align with new mainConfig structure - ([c0ca1af](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/c0ca1af2279a4a09a75896caa55c95677fcc08fe))
- *(namespace)* Update package structure to rename mod from `shared-backpack-kt` to `server-backpack` - ([04830a1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/04830a162887b80336d3d090776af974105985c9))
- *(namespace)* Suppress unused and private member visibility warnings in `NameSpaces.kt` - ([77f0e70](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/77f0e703799995386e3df1a67f1a2585eb72f9fa))
- *(namespace, lang)* Rename mod from `shared-backpack-kt` to `server-backpack` across files - ([3f16498](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/3f16498849c9db92899dbb111fecae3a4d7694c9))
- *(namespace, lang)* Update namespace and language keys to rename mod from `shared-backpack-kt` to `server-backpack` - ([d08ca07](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/d08ca078a73e54be77f1ca2f253332e8deb4b821))

### 📚 Documentation

- *(commands)* Update README to reflect new command structure and additions - ([5d0ec85](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/5d0ec85f05d4c8cbc1ba8cdb2df5e64665e604d2))
- Update README title and remove outdated image link - ([0b100d3](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/0b100d3c9d122c99191228935e5cff110a6b047d))

### ⚙️ Miscellaneous Tasks

- *(workflow)* Add `workflow_dispatch` trigger to release and pre-release workflows - ([4dc4e69](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/4dc4e69f4b960af89dd00bd53ec65ef38aa51ebb))
- *(workflow)* Remove unnecessary whitespace in `pre-release.yml` - ([7ea273f](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/7ea273f220e5a5e713c44d8e2aa98c1d77667f03))
- *(workflow)* Remove unnecessary whitespace in `release.yml` - ([8a52a9a](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/8a52a9ae5b4fd3b61ac1e0e6439d6580ab1f9c32))
- Update `.gitignore` - ([8916f4b](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/8916f4be98e14508a26cb2c7628f803986123d82))

### Action

- Update version in `gradle.properties` - ([133ccc6](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/133ccc67bc222fd0d01141b013c5c6f2f7c2ae2c))

### `build

- *(dependencies)* Remove unused dependency on yamlkt` - ([897e384](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/897e384970ab8762776d9a97739c89bc996f4e53))

### Build

- *(config)* Update compatibilityLevel to `JAVA_25` in mixin config - ([fa87913](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/fa87913e2e74388f6821e3fea07e0a575b216dee))
- *(repo)* Add `.gitattributes` to enforce consistent line endings across files - ([e1f7a58](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/e1f7a58a41a0dd27b4969227f7649e3fcb73ac4a))
- *(workflows)* Fix property key in version update step for consistency - ([f0469a1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/f0469a1172e54466b39994251f23766ed6598b8e))
- *(workflows)* Enhance Dependabot auto-merge workflow with improved checks and actions - ([64ba404](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/64ba40413455b595ede0396e486c98142eb1f83a))
- *(workflows)* Update Java versions to 25 and use Microsoft distribution - ([21c014c](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/21c014c2cf01c491e04df66d5d5275ddd58db419))
- Bump `translation_generator_version` to 0.0.24 - ([00660b1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/00660b1443a83f472e277427377486089b6827e7))
- Integrate translation generator plugin and update dependency repositories - ([45040c3](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/45040c3da7a3e36e00500dcab9750dcd7aa9127d))
...
- *(command)* Restrict `UnlimitedFurnace` commands to users with permission level 2 - ([0f44bda](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/0f44bdab8afcbd163c97ce09126aeb1ddbd4d01d))
- *(command)* Add `UnlimitedFurnace` commands with player-only and shared modes - ([5317ab7](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/5317ab714f2277984140c3fb1b9ac10f50fb8848))
- *(commands)* Add `ConfigCommand` for managing configuration options dynamically via commands - ([a23d5eb](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/a23d5eb31d1746e31389848ec09a07a05b263c07))
- *(config)* Add translation for `unlimitedFurnaceMultiplier` option - ([dd4fc15](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/dd4fc15e2196b2b299f717df5c53b615ca5747f3))
- *(config)* Add support for unlimited furnace configurations including smelting, blasting, and smoking - ([e40bbaf](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/e40bbafa09bd2f94dcd5c4d218ebaabf43f6788e))
- *(config, inventory)* Enforce minimum cook time and add config option for `unlimitedFurnaceMultiplier` constraints - ([df182eb](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/df182eb4f081a41b1704f64c72ddeff2fc592533))
- *(config, inventory)* Add `unlimitedFurnaceMultiplier` and adjust cook time calculation - ([efd5a50](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/efd5a505d9c6bd8fbcfac8639f96f20a84951c6e))
- *(inventory)* Add `CustomFurnaceMenu` and enable access widener for `AbstractFurnaceMenu` customization - ([e972021](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/e972021ef4d774ee80820682531385d976b0259f))
- *(inventory)* Add `UnlimitedFurnace` and `UnlimitedSmoker` container variants with player-only and shared modes - ([5b100be](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/5b100be404741635840fc69062a669558482329f))
- *(inventory)* Add `AbstractUnlimitedFurnaceContainer` and update `AbstractFurnaceContainer` for extended customization - ([90c448c](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/90c448c7cbf7e6de323654588b75df9fabfb66ae))
- *(lang)* Remove `en_ud` upside-down translations for cleanup and reduced clutter - ([4fb3e88](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/4fb3e8837825c20ca4c9df72a188b87911991447))
- *(lang)* Fix typos, add unlimited furnace translations, and enhance consistency across languages - ([9fe0a5d](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/9fe0a5dd976e916491790d20f227747a292052f7))
- *(lang)* Add and update translations for unlimited furnace options and improve consistency across languages - ([cd4fd62](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/cd4fd626f57f32c0eb85e6853e88d554cae5bc3a))
- *(lang)* Generate fallback translations from `en_us.json` and replace static constants - ([19e69ca](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/19e69cae369a94ba6b1df9e2f5b3c10e319b89a0))
- *(tasks)* Add `generateUpsideDownTranslation` task to create `en_ud` translations from `en_us` - ([0e554a4](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/0e554a423777f53017dc3d98d5bc7f7e98c86b41))

### 🐛 Bug Fixes

- *(command)* Correct registration typo for `UnlimitedFurnacePlayerOnlyCommand` - ([6989f0d](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/6989f0df296e6d4ec889642047b507a0c59ba820))
- *(inventory)* Handle pending container removals to prevent concurrent modification exceptions in `TickHandler` - ([9553dc5](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/9553dc50002d5ea32220bff7114791484af86459))
- *(inventory)* Prevent duplicate registrations and invalid unregistrations in `TickHandler` - ([5d44092](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/5d44092658401117bab17df0683b53d952373de7))
- *(inventory)* Correct `get` logic in `AbstractUnlimitedFurnaceContainer` to compute cooking time accurately - ([d860332](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/d86033240403fed23fb699be47a67bcba1750ef9))

### 🚜 Refactor

- *(command)* Replace `FurnaceMenu` with `CustomFurnaceMenu` in all furnace commands - ([1dee929](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/1dee9294f511b8f5812ed33e59bf4ee0afa6958a))
- *(commands)* Suppress spell-check warning in `ConfigCommand` definition - ([241e55a](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/241e55a10c50a251dd74610799e9b5beb76cbff9))
- *(commands)* Add `unused` suppression in `ConfigCommand` for improved lint compliance - ([756d02e](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/756d02e5be296a21068f8d694ee915921feed41d))
- *(commands)* Simplify `ConfigCommand` property handling with generic `handle` function - ([3c26bae](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/3c26bae2e5f992e7ff01a7675baaa523f817df72))
- *(commands)* Replace `Utils` constants with `FallbackTranslations` for improved maintainability - ([df89fef](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/df89fef241ba0baba55ec3eafef99e3ed1d5c0b2))
- *(commands)* Replace inline fallback messages with constants from `Utils` - ([52d5154](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/52d515462a5c2d625c52c78e14fc0a16cdd4c065))
- *(config)* Reorder `load` call and update logger parameter order - ([ae58ecf](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/ae58ecf9fd286724e78e77df11efa62b5e4da7c5))
- *(config)* Move `load` call to initializer and update logger usage in `SharedBackpackKt` - ([b899d5a](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/b899d5ae9406efc1b8147d1f3a208b9213e260e2))
- *(config)* Group unlimited furnace options under a new category - ([1a39f82](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/1a39f82d4c3197069d34abe8c20a1598a7544c3b))
- *(containers)* Remove redundant `@Suppress("MemberVisibilityCanBePrivate")` annotations - ([2a1ce0f](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/2a1ce0fc3da8717cf20a876b6fd2f47004012658))
- *(core)* Remove redundant newline in `SharedBackpackKt` for cleaner code - ([7ef689f](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/7ef689f2037e3d3e88c48f5a6346c0ec94febfee))
- *(core)* Simplify initialization logic and unify tick handler logging - ([0a85b71](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/0a85b712f5ed89d44c92b4950a9bc730cd05c750))
- *(furnace)* Adjust `unlimitedFurnaceMultiplier` calculation for improved safety and readability - ([92fc857](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/92fc857f3b2849e2721c3ef67d42c252fbb2db16))
- *(inventory)* Simplify player tracking logic and unify `isNoPlayersOpen` behavior across containers - ([e1bc71e](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/e1bc71ec6d1e2afc5a0117cf8f91f37a7c855293))
- *(inventory)* Replace `mutableSetOf` with `hashSetOf` for `containers` in `TickHandler` - ([673f202](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/673f202866fc06ed8a9754e65e15b76a887315fc))
- *(inventory)* Generalize `FurnaceTickHandler` to `TickHandler` and update containers for broader usage - ([c143402](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/c1434023f5dccdd5f731310af0381a092c94111b))
- *(inventory)* Remove redundant `getBurnDuration` overrides from furnace containers - ([8fe31ca](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/8fe31ca51badff9ec529d595db877340cc47ec07))
- *(lang)* Simplify furnace-related translations and improve consistency - ([0908c55](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/0908c558357f645acd4e82bfe5bc9ed1a1cd1c0d))

### 📚 Documentation

- *(changelog)* Update entry to rename `FurnaceTickHandler` to `TickHandler` - ([aa8b569](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/aa8b569f2c5d40dc47b08b4c61ddba89def4f16c))

### Action

- Update version in `gradle.properties` - ([ee2887a](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/ee2887a8ce1f5a7e4f439e941e1b2f73ee339a13))


## [0.8.1](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/compare/v0.8.0..v0.8.1) - 2026-08-11

### 🚜 Refactor

- *(inventory)* Remove `Player` dependency from containers and update `onNoPlayersOpen` signature - ([684cdfb](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/684cdfb57b821523173949e3f65e9b552d129e4a))
- *(inventory)* Simplify `AbstractFurnaceContainer` lifecycle handling and remove `Player` dependency - ([16ea35d](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/16ea35dafde33325b014ebfea3473ca427d24502))
- *(inventory)* Update `onNoPlayersOpen` signature to remove `Player` parameter for consistency - ([a71f1ac](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/a71f1ac815df473840875a940ab0f3d43574c64c))

### Action

- Update version in `gradle.properties` - ([c938c95](https://github.com/T2PeNBiX99wcoxKv3A4g/Shared-Backpack-Kt/commit/c938c95932fdc1ee5f87467758635a9e3b1d3be9))
